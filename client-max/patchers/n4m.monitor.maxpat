...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 49.0, 123.0, 22.0 ],
					"text" : "r #0-ready-for-dicts"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 511.5, 125.0, 22.0 ],
					"text" : "s #0-ready-for-dicts"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.0, 476.5, 62.0, 22.0 ],
					"text" : "bangbang"
				}
...
, 			{
				"box" : 				{
					"comment" : "Bang when the debugger has loaded",
					"id" : "obj-24",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 511.5, 30.0, 30.0 ]
				}
...
,
					"patching_rect" : [ 45.0, 86.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 132.0, 71.0, 22.0 ],
					"text" : "r #0-jweb"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 351.4444580078125, 73.0, 22.0 ],
					"text" : "s #0-jweb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 454.0, 285.66668701171875, 61.0, 22.0 ],
					"text" : "route size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.0, 318.5555419921875, 155.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 454.0, 187.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.0, 219.888885498046875, 47.0, 22.0 ],
					"text" : "getsize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.0, 252.77777099609375, 136.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "fit_jweb_to_bounds.js",
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 49.0, 29.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.0, 500.0, 134.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 63.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 29.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 94.0, 187.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "resize_n4m_monitor_patcher.js",
						"parameter_enable" : 0
					}
,
					"text" : "js resize_n4m_monitor_patcher.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 91.0, 132.0, 198.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "Connect to the right outlet of node.script",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 187.0, 400.0, 220.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 400.0, 220.0 ],
					"rendermode" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 17.0, 435.0, 161.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 500.0, 84.0, 35.0 ],
					"text" : ";\rmax reveal $1"
				}
...
, 			{
		...
		"bgcolor" : [ 1.0, 0.960784, 0.854902, 1.0 ],
